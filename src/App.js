    ...
    <div className="main-layout">
      ...
      <div className="resume-container">
        ...
        <section id="about" className="section">
          <h2>👤 About Me</h2>
          <p>
            안녕하세요. 저는 새로운 기술들을 배우는 것을 즐기며, 피드백과 커뮤니케이션을 통해 실력 있는 시스템 운영자가 되고 싶습니다. DB 엔지니어로 근무했을 당시, 현업과 소통하며 시스템 안정성과 성능을 고민해온 경험을 바탕으로, 사용자 중심의 운영과 기술을 연결하는 역할을 잘 수행하도록 노력할 것입니다!
          </p>
          <h2>📞 연락처</h2>
          <ul>
