...
function App() {
  return (
    <div className="resume-container">
      ...
      <h2>🏢 경력요약</h2>
      <ul>
        <li>GTPlus – Oracle DB 엔지니어 (2023.10.23 ~ 현재재직 약 1년 7개월 근무)</li>
      ...
      <p>Oracle DB 설치 및 데이터 이관(마이그레이션) 수행. 정합성 유지 및 시스템 안정화에 기여 개발 DB에서 차세대 운영 DB로의 1차 데이터 이관을 수행하였습니다. 이관 과정에서 데이터 정합성을 유지하고, 안정적인 운영 환경을 확보하기 위해 사전 검증 및 테스트를 진행하였으며, 시스템 안정성을 극대화하는 데 기여하였습니다.
</p>
      <h3>🔧 차세대 나라장터 DB 서버 성능테스트</h3>
      <p> Oracle TPC-DS 기준 부하 테스트 및 AWR 기반 DB 성능 분석, 개선방향 도출
</p>
